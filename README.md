...
The OPLS-DA Contrasts Galaxy tool presents an emulation of the SIMCA® OPLS-DA® S-PLOT® along with three OPLS-DA® 
plots (scores, loadings, and cross-validation) from [the Bioconductor `ropls` package, doi:10.18129/B9.bioc.ropls](https://dx.doi.org/10.18129/B9.bioc.ropls).

For each pair of treatment levels, this tool plots the correlation of each feature with the OPLS-DA® projection of multivariate data against the covariance of the same.
